...
export async function getServerSideProps({ query: { page = 1} }) {
   ...
   data.push(...first.Products.filter((obj) => obj.Category.includes("Tools")), 
             ...second.Products.filter((obj) => obj.Category.includes("Tools")), 
             ...third.Products.filter((obj) => obj.Category.includes("Tools")), 
             ...fourth.Products.filter((obj) => obj.Category.includes("Tools")), 
             ...fifth.Products.filter((obj) => obj.Category.includes("Tools")), 
             ...sixth.Products.filter((obj) => obj.Category.includes("Tools")))
      ...
      <Header/>
        ...
        <div className={styles.paginantion}>
          <div className={styles.nextPrevious}>
            <button
              onClick={() => router.push(`/tools/?page=${page - 1}`)}
              disabled={page <= 1}
            >
              Previous
            </button>
