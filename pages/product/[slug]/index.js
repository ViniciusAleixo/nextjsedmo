      ...
      <main>
        ...
        <div className={styles.containerImgSingle}>
          <div className={styles.contentSingle}>
                { Attachments.length === 0  ? <span>No Photo</span> : Attachments[0].ContentType === "application/pdf"  ? <img className={styles.cardImgSingle} src= { Attachments[1].DownloadUrl } alt={ Name } />  : <img className={styles.cardImgSingle} src= { Attachments[0].DownloadUrl } alt={ Name }  />}
                <div className={styles.cardContent}>
                  ...
                  <a className={styles.btnstore} href={`https://edmoap.dearportal.com/Product/${ID}`}  target="_blank">Go to Store</a>
