...
export async function getServerSideProps({params: {sku}}) {
 
 const response = await fetch(`https://inventory.dearsystems.com/ExternalApi/v2/Product?SKU=${sku}&IncludeAttachments=true`,{
    headers: {
