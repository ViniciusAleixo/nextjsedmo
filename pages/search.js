...
export default function Home() {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`https://inventory.dearsystems.com/ExternalApi/v2/Product?Name=${searchTerm}&IncludeAttachments=true&limit=15`, {
        headers: {
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="EDMO, the most trusted name in aviation for aircraft electronics, install supplies, wire and cable, tooling, test equipment, tactical communication, pilot." key="desc" />
      </Head>
